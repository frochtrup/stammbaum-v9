...
<style>
  ...
  .quality__score--good { border-left-color: var(--stb-ok, #5fb85f); }
  ...
  .quality__dot--clean { background: var(--stb-ok, #5fb85f); }
  ...
  .quality__bar-fill--good { background: var(--stb-ok, #5fb85f); }
